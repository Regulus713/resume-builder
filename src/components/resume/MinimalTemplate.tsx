    ...
    <div className="px-[18mm] py-[16mm] text-neutral-800">
      <header>
        ...
        <EditableText
          ...
          className={`mt-[0.15em] block text-[1em] font-medium text-(--accent) ${
            p.jobTitle ? '' : 'print:hidden'
          }`}
        />
        <div
          className={`mt-[1em] flex flex-wrap gap-x-[1.2em] gap-y-[0.25em] border-t border-neutral-200 pt-[0.7em] text-[0.75em] text-neutral-500 ${
      ...
      >
        ...
        <EditableText
          ...
          className="mt-[0.6em] block text-[0.88em] leading-relaxed whitespace-pre-line text-neutral-700"
        />
      </section>
      ...
      >
        ...
        <div className="mt-[0.7em]">
          {resume.experience.map((exp) => {
            ...
            return (
              <div key={exp.id} className="mb-[1em] break-inside-avoid last:mb-0">
                <div className="flex items-baseline justify-between gap-[1em]">
                  <div className="text-[0.92em] font-semibold">
                    <EditableText
                      value={exp.role}
                  ...
                  <div className="shrink-0 text-[0.72em] text-neutral-400">
                    <EditableText
                      value={exp.startDate}
                ...
                <EditableText
                  ...
                  className={`block text-[0.75em] text-neutral-400 ${
                ...
                <EditableLines
                  ...
                  className="mt-[0.3em] list-disc space-y-[0.1em] pl-[1.3em] text-[0.84em] leading-relaxed text-neutral-600 marker:text-neutral-300"
      ...
      >
        ...
        <div className="mt-[0.7em]">
          {resume.education.map((edu) => {
            ...
            return (
              <div key={edu.id} className="mb-[0.8em] break-inside-avoid last:mb-0">
                <div className="flex items-baseline justify-between gap-[1em]">
                  <div className="text-[0.92em] font-semibold">
                    <EditableText
                      value={edu.degree}
                ...
                <EditableText
                  ...
                  className={`mt-[0.15em] block text-[0.8em] whitespace-pre-line text-neutral-500 ${
